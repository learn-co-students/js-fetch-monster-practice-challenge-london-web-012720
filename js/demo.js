...
// let page=1;const getMonsters=a=>{console.log('get monsters function'),fetch(URL_PREFIX+`monsters/?_limit=50&_page=${a}`)
// .then(b=>b.json())
...
// addSubmitEventListener=()=>{document.querySelector('#monster-form').addEventListener('submit',a=>{
...
// //need to createa a form with 3 input field and a create button
// //createa two button to go up to go left and right 
